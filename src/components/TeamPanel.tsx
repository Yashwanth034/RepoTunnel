    ...
    <div className="team-page-stack team-simple-ui">
      ...
      {!snapshot ? (
        <section className="panel team-create-panel team-simple-create">
          ...
          <label className="team-field"><span>Success criteria <small>What must be true before this request is complete? One requirement per line.</small>Success criteria <small>What must be true before this request is complete? One requirement per line.</small></span><textarea value={criteria} onChange={(event) => setCriteria(event.target.value)} placeholder={"Core features work\nBuild/tests pass\nBrowser verification passes"} rows={4} /></label>
